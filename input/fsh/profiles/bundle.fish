...
Profile: NgePBundle
Parent: Bundle
Title: "Nigeria ePrescription Bundle"
Description: "FHIR Bundle profile for grouping Nigeria ePrescription resources including Patient, Immunization, AllergyIntolerance, RelatedPerson, and Organization. Supports request/response/search metadata for interoperability."
